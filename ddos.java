...
def help():
    ...
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"¦ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" Exit BQK.x.DDoS                        "+Fore.LIGHTCYAN_EX+"¦\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"¦-----------------------------------------------------¦\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"¦ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"THANK    "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" Thanks for using Ddos.                "+Fore.LIGHTCYAN_EX+" ¦\n")
    ...
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"¦ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Facebook "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" buiquangkhai.user      "+Fore.LIGHTCYAN_EX+"                ¦\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"+-----------------------------------------------------+\n")
    stdout.write("\n")
##############################################################################################
def credit():
    stdout.write("\x1b[38;2;0;236;250m------------------------+\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Developer "+Fore.RED+": \x1b[38;2;0;255;189mbuiquangkhai\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"UI Design "+Fore.RED+": \x1b[38;2;0;255;189mDPTA\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Methods/Tools "+Fore.RED+": \x1b[38;2;0;255;189mSbuiquangkhai\n")
    stdout.write("\x1b[38;2;0;236;250m------------------------+\n")
    stdout.write("\n")    
##############################################################################################
def layer7():
...
def title():
    ...
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                          +-----------------------------------------------+\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                #+-------------------------------------------------------------------+#\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                #¦]================[ Welcome to Attack DDoS Panel ]=================[¦#\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                #¦ - - - - - -- - - -[ BQK.x.DDoS Panel 2022 ]- - - - - - - - - - - -¦#\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                #¦------------------>> Bùi Quang Kh?i Profile :                      ¦#\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                #¦FB Bùi Quang Kh?i : https://www.facebook.com/buiquangkhai.user4/   ¦#\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                #¦Zalo Quang Kh?i : 0352876128                                       ¦#\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                #¦Web Sub,Like cá nhân : https://subngonvn.site/                     ¦#\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                #¦                                                                   ¦#\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                #¦ ----------------------------------------------------------------- ¦#\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                #¦ ----> Nh?n all kèo, h?c viên dame, unlock facebook, nh?n code web ¦#\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                #¦anti ddos, bán tool ddos, botnet,setup botnet, Nh?n Unl 282,956,   ¦#\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                #¦thi?t k? website, design logo, làm tool theo YC, b?o m?t web       ¦#\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"                #+-------------------------------------------------------------------+#\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTCYAN_EX+"+---"+Fore.LIGHTCYAN_EX+"[""root"+Fore.LIGHTGREEN_EX+"@"+Fore.LIGHTCYAN_EX+"Buiquangkhai"+Fore.CYAN+"]"+Fore.LIGHTCYAN_EX+"\n+--\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
